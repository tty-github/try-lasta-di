 ...
 */
package com.example.db.bsentity.dbmeta;
...
import com.example.db.allcommon.*;
import com.example.db.exentity.*;
...
public class MemberFollowingDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnMemberFollowingId = cci("MEMBER_FOLLOWING_ID", "MEMBER_FOLLOWING_ID", null, "会員フォローイングID", Long.class, "memberFollowingId", null, true, true, true, "BIGINT", 19, 0, "NEXT VALUE FOR PUBLIC.SYSTEM_SEQUENCE_A08EE543_8252_495E_99C8_0F7547DF11BA", false, null, null, null, null, null, false);
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "com.example.db.exentity.MemberFollowing"; }
    public String getConditionBeanTypeName() { return "com.example.db.cbean.MemberFollowingCB"; }
    public String getBehaviorTypeName() { return "com.example.db.exbhv.MemberFollowingBhv"; }
