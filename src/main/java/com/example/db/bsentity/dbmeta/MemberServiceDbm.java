...
public class MemberServiceDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnMemberServiceId = cci("MEMBER_SERVICE_ID", "MEMBER_SERVICE_ID", null, "会員サービスID", Integer.class, "memberServiceId", null, true, true, true, "INTEGER", 10, 0, "NEXT VALUE FOR PUBLIC.SYSTEM_SEQUENCE_A5B6BB5E_E371_49B4_909D_2AF13916E7D5", false, null, null, null, null, null, false);
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "com.example.db.exentity.MemberService"; }
    public String getConditionBeanTypeName() { return "com.example.db.cbean.MemberServiceCB"; }
    public String getBehaviorTypeName() { return "com.example.db.exbhv.MemberServiceBhv"; }
