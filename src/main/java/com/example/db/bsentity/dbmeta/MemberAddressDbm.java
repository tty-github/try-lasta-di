...
public class MemberAddressDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnMemberAddressId = cci("MEMBER_ADDRESS_ID", "MEMBER_ADDRESS_ID", null, "会員住所ID", Integer.class, "memberAddressId", null, true, true, true, "INTEGER", 10, 0, "NEXT VALUE FOR PUBLIC.SYSTEM_SEQUENCE_958C7E59_3C64_4C8D_85A1_D7A724BDB1BE", false, null, null, null, null, null, false);
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "com.example.db.exentity.MemberAddress"; }
    public String getConditionBeanTypeName() { return "com.example.db.cbean.MemberAddressCB"; }
    public String getBehaviorTypeName() { return "com.example.db.exbhv.MemberAddressBhv"; }
