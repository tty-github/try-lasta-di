...
public class PurchasePaymentDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnPurchasePaymentId = cci("PURCHASE_PAYMENT_ID", "PURCHASE_PAYMENT_ID", null, "購入支払ID", Long.class, "purchasePaymentId", null, true, true, true, "BIGINT", 19, 0, "NEXT VALUE FOR PUBLIC.SYSTEM_SEQUENCE_27482751_5209_4A62_A00A_806F65A2349C", false, null, null, null, null, null, false);
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "com.example.db.exentity.PurchasePayment"; }
    public String getConditionBeanTypeName() { return "com.example.db.cbean.PurchasePaymentCB"; }
    public String getBehaviorTypeName() { return "com.example.db.exbhv.PurchasePaymentBhv"; }
