...
public class ProductDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnProductId = cci("PRODUCT_ID", "PRODUCT_ID", null, null, Integer.class, "productId", null, true, true, true, "INTEGER", 10, 0, "NEXT VALUE FOR PUBLIC.SYSTEM_SEQUENCE_6E0F4287_9B17_4A0C_9231_32122A3A45EB", false, null, null, null, "purchaseList", null, false);
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "com.example.db.exentity.Product"; }
    public String getConditionBeanTypeName() { return "com.example.db.cbean.ProductCB"; }
    public String getBehaviorTypeName() { return "com.example.db.exbhv.ProductBhv"; }
