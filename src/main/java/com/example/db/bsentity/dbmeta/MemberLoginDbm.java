...
public class MemberLoginDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnMemberLoginId = cci("MEMBER_LOGIN_ID", "MEMBER_LOGIN_ID", null, "会員ログインID", Long.class, "memberLoginId", null, true, true, true, "BIGINT", 19, 0, "NEXT VALUE FOR PUBLIC.SYSTEM_SEQUENCE_A77ABF1B_C999_4EF8_8420_2A67C46AB386", false, null, null, null, null, null, false);
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "com.example.db.exentity.MemberLogin"; }
    public String getConditionBeanTypeName() { return "com.example.db.cbean.MemberLoginCB"; }
    public String getBehaviorTypeName() { return "com.example.db.exbhv.MemberLoginBhv"; }
